<section class="-x-block">
  <div class="header text-light -x-block-bg-img" style="">
    <div class="header-overlay -x-block-bg-color" style="background-color:rgba(0,144,52,1)">
      <div class="container">
        <div class="header-padding-xl">
          <div class="row">
            <div class="col-md-12 col-lg-6 push-lg-6 text-center text-lg-right order-lg-1">
              <div class="-x-text">
