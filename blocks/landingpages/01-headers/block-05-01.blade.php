<section class="-x-block">
  <div class="header text-light">
    <div class="header-overlay -x-block-bg-gradient" style="background: #4776e6; background: linear-gradient(to bottom, #87e0fd 0%,#05abe0 100%);">
      <div class="container">
        <div class="header-padding-xl">
          <div class="row">
            <div class="col-8 push-2 col-sm-8 push-sm-2 col-lg-6 push-lg-6">
