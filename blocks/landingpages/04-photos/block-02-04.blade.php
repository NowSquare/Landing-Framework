  ...
  <div class="content -x-block-bg-img text-light" style="">
    <div class="content-overlay -x-block-bg-color" style="background-color:rgba(0,0,0,0.8)">
      <div class="container">
        <div class="row">
          <div class="col-md-5">
            <a href="/templates/assets/images/photos/cars-new-york-city-cab-taxi.jpg" data-toggle="lightbox"><img src="/templates/assets/images/photos/cars-new-york-city-cab-taxi.jpg" alt="" class="-x-img img-fluid mdl-shadow--8dp"></a>
          </div>
          <div class="col-md-7">
