  ...
  <div class="content -x-block-bg-img" style="">
    <div class="content-overlay -x-block-bg-color" style="background-color:rgba(255,255,255,1)">
      <div class="container">
        <div class="row">
          <div class="col-md-5">
            <a href="/templates/assets/images/photos/businesswoman-interview-meeting.jpg" data-toggle="lightbox"><img src="/templates/assets/images/photos/businesswoman-interview-meeting.jpg" alt="" class="-x-img img-fluid mdl-shadow--8dp"></a>
          </div>
          <div class="col-md-7">
