      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            <img src="{{ url('/templates/assets/images/logos/logo-red.svg') }}" class="-x-img" data-offset="10px 5px" data-attachment="bottom right" data-target-attachment="center left">
          </div>
          <div class="col-12">
