      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 pull-md-8 text-center text-md-left">
            <div class="btn-container mt-md-1">
              <a class="btn btn-xlg btn-outline-yellow btn-block -x-link" href="#" data-offset="0px 25px" data-target-attachment="top left" role="button">{!! trans('landingpages::block.contact_us') !!}</a>
            </div>
          </div>
        </div>
      </div>
