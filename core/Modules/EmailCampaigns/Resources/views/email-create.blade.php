      ...
      <nav class="navbar navbar-default card-box sub-navbar">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand no-link" href="javascript:void(0);">\</a>
            <a class="navbar-brand no-link" href="javascript:void(0);">{{ trans('emailcampaigns::global.create_email') }}</a>
          </div>
<?php /*
      ...
      >
        ...
        <div>
          <div class="text-center">
            <a href="#/emailcampaigns/emails/create/{{ $sl }}/{{ $category['category'] }}">
          ...
          <div class="panel-footer">
            <a href="#/emailcampaigns/emails/create/{{ $sl }}/{{ $category['category'] }}" class="btn btn-lg btn-primary btn-block">{{ trans('global.select') }}</a>
          </div>
        </div>
      </div>
