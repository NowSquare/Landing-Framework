...
return array(
  ...
  // Generic content
  "content_button" => "Meer",
  "content_button2" => "Aanmelden",
  "content_title1" => "Consultancy",
  "content_title2" => "Resultaten",
  "content_title3" => "Marketing",
  "content_title4" => "Connect",
  "content_title5" => "Geweldige functies",
  "content_title6" => "Streamline uw workflow",
  "content_title7" => "Al de gereedschappen die u nodig hebt",
  ...
  "content_feature" => "Kenmerk",
  "content_feature_line" => "Dit is een geweldige functie.",
  "copyright" => "Copyright",
  "great_event" => "Geweldig evenement",
  "festival_head" => "Fun Fair Festival met ritten, eten en muziek",
  "get_tickets" => "Koop kaartjes",
  "all_right_reserved" => "Alle rechten voorbehouden",
  "disclaimer" => "Disclaimer",
  "what_our_customers_are_saying" => "Wat onze klanten zeggen",
