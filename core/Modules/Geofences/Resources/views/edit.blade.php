      ...
      <nav class="navbar navbar-default card-box sub-navbar">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand no-link" href="javascript:void(0);">{{ trans('geofences::global.edit_geofence') }}</a>
          </div>
        ...
        <div class="panel panel-default">
          <fieldset class="panel-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="name" id="name" value="{{ $geofence->name }}" required autocomplete="off">
            </div>
          
            <div class="form-group" style="margin-top:20px">
              <div class="checkbox checkbox-primary">
                <input name="active" id="active" type="checkbox" value="1" <?php if ((boolean) $geofence->active) echo 'checked'; ?>>
          ...
          <fieldset class="panel-body">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="number" class="form-control" name="radius" id="radius" required min="100" value="{{ $geofence->radius }}">
      ...
      <div class="col-md-6">
        <div class="panel panel-default">
          ...
          <fieldset>
            ...
            <input type="hidden" id="lat" name="lat" value="{{ $geofence->lat }}">
            <input type="hidden" id="lng" name="lng" value="{{ $geofence->lng }}">
            <input type="hidden" id="zoom" name="zoom" value="{{ $geofence->zoom }}">
          </fieldset>
        </div>
      </div>
      <!-- end col -->
