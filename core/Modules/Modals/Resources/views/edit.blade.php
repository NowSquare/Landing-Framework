      ...
      <nav class="navbar navbar-default card-box sub-navbar">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand no-link" href="javascript:void(0);">{{ trans('modals::global.edit_modal') }}</a>
          </div>
        ...
        <div class="panel panel-default">
          ...
          <fieldset class="panel-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="name" id="name" value="{{ $modal->name }}" required autocomplete="off">
            </div>
          
            <div class="form-group" style="margin-top:20px">
              <div class="checkbox checkbox-primary">
                <input name="active" id="active" type="checkbox" value="1" <?php if ((boolean) $modal->active) echo 'checked'; ?>>
...
?>            </select>
            ...
            <div class="form-group" style="margin-bottom: 0">
              <input type="text" class="form-control" name="url" id="url" value="{{ $modal->settings['modalUrl'] ?? '' }}" required placeholder="{{ trans('modals::global.url_placeholder') }}" autocomplete="off">
            </div>
...
echo Former::select('trigger')
  ...
  ->forceValue($modal->settings['trigger'] ?? 'onload')
              ...
              <div class="col-md-6">
                <div class="form-group" id="trigger_onscroll" style="display: none">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" name="scrollTop" id="scrollTop" required value="{{ $modal->settings['scrollTop'] ?? '40' }}">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" name="delay" id="delay" required value="{{ $modal->settings['delay'] ?? '0' }}">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" name="ignoreAfterCloses" id="ignoreAfterCloses" required value="{{ $modal->settings['ignoreAfterCloses'] ?? '1' }}">
...
$allowedHosts = $modal->settings['allowedHosts'] ?? [];
$allowedHosts_values = array_combine($allowedHosts, $allowedHosts);
...
echo Former::select('allowedHosts[]')
  ...
  ->options($allowedHosts_values)
  ->forceValue($allowedHosts)
...
$allowedPaths = $modal->settings['allowedPaths'] ?? [];
$allowedPaths_values = array_combine($allowedPaths, $allowedPaths);
...
echo Former::select('allowedPaths[]')
  ...
  ->options($allowedPaths_values)
  ->forceValue($allowedPaths)
...
echo Former::select('position')
  ...
  ->forceValue($modal->settings['contentPosition'] ?? 'center')
...
?>
              ...
              <div class="col-md-6">
                <div class="form-group" style="margin-top:34px">
                  <div class="checkbox checkbox-primary">
                    <input name="shadow" id="shadow" type="checkbox" value="1" <?php 
$contentClasses = $modal->settings['contentClasses'] ?? false;
$contentClasses = ($contentClasses == '-lm-shadow--8dp') ? true : false;
if ((boolean) $contentClasses) echo 'checked';

?>>
                    <label for="shadow">{{ trans('modals::global.shadow') }}</label>      </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" name="width" id="width" required value="{{ $modal->settings['contentWidth'] ?? '800' }}">
              ...
              <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" name="height" id="height" required value="{{ $modal->settings['contentHeight'] ?? '450' }}">
                    <div class="input-group-addon">px</div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group" style="margin-top:20px">
                  <div class="checkbox checkbox-primary">
                    <input name="backdropVisible" id="backdropVisible" type="checkbox" value="1" <?php if ((boolean) $modal->settings['backdropVisible'] ?? true) echo 'checked'; ?>>
                ...
                <div class="form-group">
                  ...
                  <div class="colorpicker-backdrop input-group colorpicker-element colorpicker-component">
                    <input type="text" id="backdrop_color" name="backdrop_color" value="{{ $modal->settings['backdropBgColor'] ?? 'rgba(0,0,0,0.85)' }}" class="form-control">
              ...
              <div class="col-md-6">
                <div class="form-group" style="margin-top:20px">
                  <div class="checkbox checkbox-primary">
                    <input name="showLoader" id="showLoader" type="checkbox" value="1" <?php if ((boolean) $modal->settings['showLoader'] ?? true) echo 'checked'; ?>>
                ...
                <div class="form-group">
                  ...
                  <div class="colorpicker-loader input-group colorpicker-element colorpicker-component">
                    <input type="text" id="loader_color" name="loader_color" value="{{ $modal->settings['loaderColor'] ?? '#ffffff' }}" class="form-control">
                    <span class="input-group-btn add-on">
                      <button class="btn btn-white" type="button" style="padding:0; background-color:#fff; border:1px solid #eee;">
                        <i style="background-color: rgb(255, 255, 255);height:31px;width:31px"></i>
                      </button>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="colorpicker-close input-group colorpicker-element colorpicker-component">
                    <input type="text" id="close_color" name="close_color" value="{{ $modal->settings['closeBtnColor'] ?? '#000000' }}" class="form-control">
                    <span class="input-group-btn add-on">
                      <button class="btn btn-white" type="button" style="padding:0; background-color:#fff; border:1px solid #eee;">
                        <i style="background-color: rgb(255, 255, 255);height:31px;width:31px"></i>
                      </button>
              ...
              <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" name="closeBtnMargin" id="closeBtnMargin" required value="{{ $modal->settings['closeBtnMargin'] ?? '15' }}">
                    <div class="input-group-addon">px</div>
                  </div>
                </div>
              </div>
