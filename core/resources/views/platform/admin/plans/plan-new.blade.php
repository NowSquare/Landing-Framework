            ...
            <div class="tab-content" style="padding-bottom:10px">
              <div class="tab-pane active" id="monthly">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="monthly_price" value="" required autocomplete="off" placeholder="11.25">
                </div>
              ...
              <div class="tab-pane" id="annual">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="annual_price" value="" required autocomplete="off" placeholder="9">
                </div>
