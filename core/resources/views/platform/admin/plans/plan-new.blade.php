        ...
        <div class="panel panel-default">
          ...
          <fieldset class="panel-body">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" name="price1" value="" required autocomplete="off" placeholder="100">
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="price1_string" value="" required autocomplete="off" placeholder="$100">
            </div>

            <div class="form-group">
              <label for="name">{{ trans('global.price_period') }}</label>
              <input type="text" class="form-control" name="price1_period_string" value="" autocomplete="off" placeholder="/mo">
            </div>
