        ...
        <div class="panel panel-default">
          ...
          <fieldset class="panel-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="support_email" id="support_email" value="{{ $reseller->support_email }}" required autocomplete="off">
            </div>
                ...
                <div class="col-md-8">
                  ...
                  <fieldset>
                    ...
                    <div class="form-group m-b-30">
                      <div class="checkbox checkbox-primary">
                        <input name="website_active" id="website_active" type="checkbox" value="1" <?php if($website_active) echo ' checked'; ?>>
          ...
          <div class="tab-pane" id="mail_settings">
            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="mail_from_name" id="mail_from_name" value="{{ $reseller->mail_from_name }}" autocomplete="off" placeholder="{{ $main_reseller->mail_from_name }}">
              </div>

              <div class="form-group">
                <label for="mail_from_address">{{ trans('global.sender_address') }}</label>
                <input type="text" class="form-control" name="mail_from_address" id="mail_from_address" value="{{ $reseller->mail_from_address }}" autocomplete="off" placeholder="{{ $main_reseller->mail_from_address }}">
              </div>
              ...
              <div class="form-group">
                ...
                echo Former::select('mail_driver')
                  ...
                  ->name('mail_driver')
                  ->forceValue($reseller->mail_driver)
          ...
          <div class="tab-pane" id="payment">
            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="custom_affiliate_id" id="custom_affiliate_id" autocomplete="off" value="<?php echo (isset($reseller->settings['custom_affiliate_id'])) ? $reseller->settings['custom_affiliate_id'] : ''; ?>">
              ...
              <div class="form-group m-t-20">
                ...
                <input type="text" class="form-control" name="user_query_parameter" id="user_query_parameter" value="{{ $user_query_parameter }}" autocomplete="off" placeholder="{{ $user_query_parameter_placeholder }}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="affiliate_query_parameter" id="affiliate_query_parameter" value="{{ $affiliate_query_parameter }}" autocomplete="off" placeholder="{{ $affiliate_query_parameter_placeholder }}">
