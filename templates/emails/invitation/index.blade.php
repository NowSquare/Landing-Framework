    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
      ...
      <tr>
				<td align="center" valign="top">
					<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
            <tr>
							<td valign="top" align="center" class="bodyContentBtns">
      ...
      <tr>
            ...
            <tr>
							<td valign="top" class="bodyContent" mc:edit="body_content_newsletter_02">
                <p style="margin-bottom:2px;"><strong>Sunday, 9th August, 2015</strong></p>
                <p>12:00 PM - 10:00 PM (PST)</p>

                <p style="margin-bottom:2px;"><strong>Golden Gate Park</strong></p>
                <p>1700-1798 Lincoln Way, San Francisco, CA 94122</p>
							</td>
						</tr>
					</table>
				</td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddleBtm">
									<tr>
										<td valign="top" class="bodyContent" mc:edit="body_content">
											<h4>Last year was a real hoot David. Really hope you can make it this year, looking forward to seeing you. All the best David.</h4>
										</td>
									</tr>
									<tr align="top">
...
<style type="text/css">
  ...
  */
  ...
  @media only screen and (max-width: 480px), screen and (max-device-width: 480px) {
    ...
    td[class="bodyContentBtns"] { padding: 5% 6% 5% 6% !important; }
    ...
    table[class="column"] a {
      width: 100% !important;
    	max-width: 100% !important;
      display: block;
    }
    table[class="column"] img {
      width: 100%;
      height: auto;
    }
    table[class="column"] h4 {
